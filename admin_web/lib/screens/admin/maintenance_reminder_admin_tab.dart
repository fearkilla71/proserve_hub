...
class _MaintenanceReminderAdminTabState
  ...
  Widget build(BuildContext context) {
    ...
    final convRate = _totalSent == 0
        ? 0.0
        : (_totalConverted / _totalSent) * 100;
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              _kpi(
                'Sent',
                NumberFormat.compact().format(_totalSent),
                AdminColors.accent3,
              ),
              _kpi(
                'Conv Rate',
          ...
          child: filtered.isEmpty
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    final sent = (c['remindersSent'] as num?)?.toInt() ?? 0;
                    final conv = (c['conversions'] as num?)?.toInt() ?? 0;
                    final intervalDays =
  ...
  void _showCampaignDialog(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(campaign == null ? 'New Campaign' : 'Edit Campaign'),
        content: SizedBox(
          width: 380,
          child: Column(
          ...
          FilledButton(
            onPressed: () async {
              final data = {
                ...
                'intervalDays': int.tryParse(intervalCtrl.text.trim()) ?? 30,
