...
class _CabinetRequestFlowPageState extends State<CabinetRequestFlowPage> {
  ...
  void initState() {
    super.initState();
    PricingEngine.getUnit(service: 'Cabinets').then((u) {
      if (!mounted) return;
  ...
  String _buildDescription({
    ...
    final doors = _parseInt(_doorsController.text);
    ...
    return 'Cabinet project\n'
        ...
        'Estimated cabinet doors: ${doors > 0 ? doors : 'Not sure'}\n'
    ...
    try {
      ...
      batch.set(jobRef, {
        ...
        'cabinetQuestions': {
          ...
          'cabinet_doors': _parseInt(_doorsController.text),
          'timeline': _timeline,
        },
      });
      ...
      case 0:
        return ListView(
          ...
          children: [
            ...
            Text(
              'Answer a few quick questions to match you with cabinet pros near you.',
            ...
            const SizedBox(height: 16),
            Text(
              'About how big is the kitchen/space?',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                helperText: unit.toLowerCase().contains('sqft')
                    ? 'Example: 150'
                    : 'Enter a number (example: 12)',
              ),
              onChanged: (_) => setState(() {}),
            ),
            const SizedBox(height: 16),
            Text(
              'About how many cabinet doors?',
              style: textTheme.titleLarge?.copyWith(
                fontWeight: FontWeight.w700,
              ),
            ),
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Doors (optional)',
                helperText: 'Example: 20 (leave blank if unsure)',
              ),
            ),
          ],
        );
      ...
      case 4:
        return _radioList(
          ...
          items: const [
            ...
            _RadioItem(value: 'change', label: 'Change color'),
            _RadioItem(value: 'not_sure', label: "I'm not sure"),
          ],
