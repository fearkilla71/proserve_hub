...
abstract class AppLocalizations {
  ...
  /// The application title shown in various places
  ///
  ...
  /// Button to request a job from a contractor
  ///
  /// In en, this message translates to:
  /// **'Request Job'**
  ...
  /// Alert title when a booking is confirmed
  ///
  /// In en, this message translates to:
  /// **'Booking Confirmed'**
  String get bookingConfirmed;

  /// Placeholder in the error log when empty
  ///
  /// In en, this message translates to:
